...
import com.example.portermanagementsystem.Activity.CreateUserActivity;
...
public class StaffIDScannerActivity extends AppCompatActivity {

    private static final String TAG = "ScannerStaffIDActivity";
    ...
    private void createCameraSource() {
        ...
        cameraPreview.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder surfaceHolder) {
                ...
                if (ActivityCompat.checkSelfPermission(StaffIDScannerActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    return;
                }
                try {
                            ...
                            if (!barcodeValue.equals("")) {
                                ...
                                if(validCase) {
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            Toast.makeText(StaffIDScannerActivity.this, "Valid StaffID : " + barcodeValue, Toast.LENGTH_SHORT).show();
                                            Intent intent = new Intent(StaffIDScannerActivity.this, CreateUserActivity.class);
                                    ...
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            Toast.makeText(StaffIDScannerActivity.this, "Invalid StaffID", Toast.LENGTH_SHORT).show();
                                            //Bring back to remark page
                                            Intent intent = new Intent(StaffIDScannerActivity.this, RemarkActivity.class);
                                            startActivityForResult(intent, 1);
                                            finish();
                                        }
                                    });
